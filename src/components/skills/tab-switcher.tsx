...
import { Database, BarChart3, BookOpen, Crown, Newspaper, ChevronDown, GitBranch, Swords, Calculator, Trophy } from 'lucide-react'
import { cn } from '@/lib/utils'
import { APP_VERSION, GIT_TAGS } from '@/lib/version'

export type ViewMode = 'data' | 'meta' | 'matchups' | 'tierlist' | 'patches' | 'sessions' | 'docs' | 'dmgcalc'
...
export function TabSwitcher({ view, onChange }: { view: ViewMode; onChange: (v: ViewMode) => void }) {
  ...
  const tabs: { id: ViewMode; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'sessions', label: 'Sessions', icon: <Trophy className="size-3.5" /> },
